...
class NumberGrids
{
    constructor()
    {
        ...
        this.text = document.getElementsByClassName("numbers");
    }
        ...
        for (let i = 0; i < 4; i++)
            for (let j = 0; j < 4; j++)
                ...
                else
                {
                    ...
                    newContent.setAttribute("position", "absolute");
                    newContent.setAttribute("left", String(width / 2 - height / 2 + j * (gap + grid_size) + gap));
                    newContent.setAttribute("top", String(i * (gap + grid_size) + gap));
